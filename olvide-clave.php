...
<html> 
<head>
<title>Recuperar contraseña | Giamber Lubricantes | Bahía Blanca | <?php echo getCategoriasLeyenda(); ?></title>
<meta charset="UTF-8" />
...
<div class="contenedor contenedor-corto">
	...
	<form action="actions/olvide-clave.php" method="post">
		...
		<input class="campo boton espacio" class="boton" value="Pedir contraseña" type="submit" required /> 
