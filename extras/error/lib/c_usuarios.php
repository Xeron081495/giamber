...
class Usuario{
	...
	public function getPedido(){
		...
		$consulta = "SELECT pe.id as id_pedido, pa.id as id_pago, pe.correo, pe.fecha, pe.hora, pe.envio, pa.informacion, pa.estado, pa.id_cliente, pa.id_secret 
					FROM pedidos as pe LEFT JOIN pagos as pa 
					ON pe.id=pa.id_pedido 
					WHERE pe.correo='$this->correo' AND envio is NULL
