	...
	<section id="contenido">
		...
		<form action="actions/editar-producto.php?id=<?php echo $p->getID(); ?>" method="post" enctype="multipart/form-data">
			...
			<label>
				...
				<input name="modelo" value="<?php echo $p->getModelo(); ?>" class="campo_input" min="0" type="number" />
			</label>
			<label>
			...
			?>
				...
				<label>
					...
					<input name="stock<?php echo $v->getID(); ?>"  value="<?php echo $v->getStock(); ?>" class="campo_input" min="0" type="number" required>
				</label>
				<label>
					<div class="campo_nombre">Precio por unidad*</div>
					<input name="precio_unidad<?php echo $v->getID(); ?>" value="<?php echo $v->getPrecioUnidad(); ?>" class="campo_input"  min="0.01" step="0.01" type="number" required />
				</label>
				<label>
				...
				<label>
					...
					<input name="precio_mayorista<?php echo $v->getID(); ?>" class="campo_input" value="<?php echo $v->getPrecioMayorista(); ?>"  min="0.01" step="0.01" type="number" required />
				</label>
