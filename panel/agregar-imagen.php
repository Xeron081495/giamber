...
//lugar
$id_lugar = 2;
$lugar = 'Agregar imagen a '.$p->getNombre();
...
<section id="cuerpo">
	...
	<section id="contenido">
		...
		<form action="actions/editar-imagen-producto.php?id=<?php echo $p->getID(); ?> " method="post" enctype="multipart/form-data">
			...
			<label>
				...
				<input name="prioridad" class="campo_input" type="number" required />
			</label>
			<label id="largo">
				<input class="campo_boton" value="Agregar imagen" type="submit" />
			</label>
